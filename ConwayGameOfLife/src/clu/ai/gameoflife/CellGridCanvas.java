...
public class CellGridCanvas extends Canvas {
    ...
    public CellGridCanvas(CellGrid cellGrid, int cellSize) {
        ...
        //line color
        setBackground(new Color(0xEAE8D8));
    ...
    /**
     * Record the first click on the panel
     *
     * @param x x-coordinate
     * @param y y-coordinate
     */
    public void saveCellUnderMouse(int x, int y) {
        //System.out.println("saveCellUnderMouse = " + x + "," + y );
        try {
    ...
    public void paint(Graphics g) {
        ...
        if (offScreenImageDrawed == null) {
            ...
            //System.out.println("width, height = " + d.width + "," + d.height );
    ...
    public synchronized void setShape(Shape shape) throws ShapeException {
        ...
        //check shape weather it fits the panel
    ...
    public synchronized void setLoadedShape(Shape shape) throws ShapeException {
        int xOffset = 0;
        int yOffset = 0;
        Dimension dimShape;
        Dimension dimGrid;
